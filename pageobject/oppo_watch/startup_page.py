...
class Login_Page_OppoWatch(Bagepage):
    cbAgreement=(By.ID, "com.qiwu.adultwatch:id/cbAgreement")  # 同意协议按钮
    tvUserAgreement=(By.ID, "com.qiwu.adultwatch:id/tvUserAgreement") #用户协议链接
    tvPrivacyAgreement=(By.ID, "com.qiwu.adultwatch:id/tvPrivacyAgreement") #隐私协议链接
    #tvExit = (By.ID, "com.qiwu.adultwatch:id/tvExit")  # 退出按钮
    tvExit = (By.ID, "com.qiwu.adultwatch:id/vLeft")  # 退出按钮
    #tvEnter = (By.ID, "com.qiwu.adultwatch:id/tvEnter")  # 进入按钮
    tvEnter = (By.ID, "com.qiwu.adultwatch:id/vRight")  # 进入按钮
    systemui=(By.CLASS_NAME,"//*[@text='晓悟故事']")
    tvTitle = (By.ID, "com.qiwu.adultwatch:id/tvTitle")  # 协议标题
