...
class menuone_Page_XiaoXun(Bagepage):
    homepage=(By.XPATH,"//*[@resource-id='com.qiwu.watch:id/rvMenu']/android.view.ViewGroup[1]/android.view.ViewGroup[1]")#主页
    ...
    tvBottom = (By.ID, "com.qiwu.watch:id/vBottom")  # 登入注册按钮,退出登入按钮
    cvBottom=(By.CLASS_NAME,"android.view.View")#取消登入按钮
    ivCodeLogin=(By.ID,"com.qiwu.watch:id/ivCodeLogin")#二维码图片
    #请使用微信扫码登入
    flDelete=(By.ID,"com.qiwu.watch:id/flDelete")#收藏界面删除按钮
    tvCancel=(By.ID,"com.qiwu.watch:id/vRight")#取消删除收藏,取消登入
    tvConfirm=(By.ID,"com.qiwu.watch:id/vLeft")#确定删除收藏,确认登入
    tvConfirm1 = (By.ID, "com.qiwu.watch:id/tvConfirm")  # 保存昵称修改按钮
    tvContent=(By.ID,"com.qiwu.watch:id/tvContent")#删除收藏作品名，text 野蛮女友-曼婷
    tvUserName=(By.ID,"com.qiwu.watch:id/tvUserName")#用户ID
    etContent=(By.ID,"com.qiwu.watch:id/etContent")#昵称输入框
    ivDelete=(By.ID,"com.qiwu.watch:id/saDelete")#昵称输入框删除
    ImageView = (By.CLASS_NAME, "android.widget.ImageView")  # 弹出的警告
    vNationalRanking = (By.ID, "com.qiwu.watch:id/vNationalRanking")  # 全国榜
    tvTime = (By.ID, "com.qiwu.watch:id/tvTime")  # 每日00:30更新数据
    myid=(By.ID,"com.qiwu.watch:id/me")#我的
    ivRanking=(By.ID,"com.qiwu.watch:id/ivRanking")#全国榜排名
    ...
    def tvConfirm1_click(self):
        self.click(self.tvConfirm1)
